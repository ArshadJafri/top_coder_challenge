...
image_dir = "/app/data/provisional/products/product_2/images/"
...
for img in images:
    for _ in range(200):
        augmented_images.append(train_transformer(img))

augmented_dir = "/app/data/provisional/products/product_2/augmented/"
...
training_args = TrainingArguments(
    output_dir="/app/models/product_2/",
